...
/**
 * Composant de gestion de la caisse
 */
...
/** Le nombre de consignes payées et donc à rendre */
...
/**
 * Utilise la fonction exposée reset() du composant Product
...
/**
 *
 * Validation et enregistrement des achats
 * @param mode
 * @param account
 * @param event
 * @returns {Promise<void>}
...
/**
 * Enregistre le nom de la personne qui ouvre ou complète une ardoise
 * @param name
 */
...
/**
 * Liste et enregistre la liste des personnes qui ont une ardoise ouverte
 * @returns {Promise<void>}
 */
...
/**
 * Affiche le formulaire d'enregistrement d'une ardoise
 * @param val
 */
    ...
    <div class="">
        ...
        <div class="pb-3">
            ...
            <div class="py-3 rounded-lg flex items-center justify-between text-white">
                ...
                <button v-if="returnables > 0" @click="returnableReturn"
                        class=" h-[50px] bg-black product-name flex items-center text-md font-bold rounded-lg relative  pe-4 w-full">
            ...
            <div class="selling-list mt-3 flex flex-col gap-4 p-4 bg-gray-200 relative">
                ...
                <div class="flex items-center cart-total w-full gap-5">
                    ...
                    <span
                        class="text-[25px] flex-1 font-bold rounded-lg text-gray-500 bg-white px-4 h-[50px] total flex items-center justify-center">
                        {{ globalTotal }} €
                    </span>
            ...
            <div class="flex justify-between mt-4 flex-wrap gap-4">
                ...
                <div class="w-full flex justify-start items-end">
                    ...
                    <svg v-if="mustShowAccount" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256">
...
<!--    Formulaire d'enregistrement des ardoises-->
